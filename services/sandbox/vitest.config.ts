...
// Package-local Vitest config so `pnpm --filter @utter/sandbox test` resolves the
...
// is resolved against the package cwd (services/sandbox/apps/studio/vitest.config.ts),
