...
// Package-local Vitest config so `pnpm --filter @utter/x402-arc test` resolves the
...
// is resolved against the package cwd (packages/x402-arc/apps/studio/vitest.config.ts),
